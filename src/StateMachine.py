...
class StateMachine (object):
    def __init__(self):
        ...
        self.addr = '/home/user/catkin_ws/src/ur_script_control/yaml/poses.yaml'
    ...
    def testSequence(self):
        self.sendMove(self.buildMove('j',self.getPos('Start')))
        rospy.sleep(2)
        self.sendMove(self.buildMove('j',self.getPos('prepick')))
        rospy.sleep(2)
        self.sendMove(self.buildMove('l',self.getPos('pick')))
        rospy.sleep(2)
        self.sendMove(self.buildMove('l',self.getPos('prepick')))
        rospy.sleep(2)
        self.sendMove(self.buildMove('j',self.getPos('Start')))
